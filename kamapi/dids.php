...
/*
URL               : https://example.com/kamapi/dids.php
        ...
        */
        ...
        if ($id == Null) {
            ...
            $rows = array(
                ...
                'SampleURLFormat' => '{"URL": "https://examples.com/kamapi/dids.php?id=10","headers" : "HTTP_ACCEPT: text/html or application/json or application/xml"}'
            );
            $response = json_encode($rows);
            echo $response;
            return;
        ...
        */
        if (isset($post_data["did"]) AND isset($post_data["destination_domain"])) {
            ...
            if ($did == "" or $did == " " or $destination_domain == "" or $destination_domain == " ") {
                $this->invalid_data_format('[{"did":"9999999999","destination_domain":"127.0.0.1"}]');
                return;
            }
        } else {
            $this->invalid_data_format('[{"did":"9999999999","destination_domain":"127.0.0.1"}]');
        ...
        */
        ...
        foreach ($post_data_items as $post_data) {
            ...
            if (isset($post_data["did"]) AND isset($post_data["destination_domain"])) {
                ...
                $this->invalid_data_format('[{"did":"9999999999","destination_domain":"127.0.0.1"},{"did":"9999999999","destination_domain":"127.0.0.1"}]');
                return;
            }
            $db = new DB();
            $conn = $db->connect();
